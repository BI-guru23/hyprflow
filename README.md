# 🎉 hyprflow - Your Voice Assistant for Linux Made Easy
...
3. Install hyprflow using the following command:

   ```bash
   sudo dpkg -i hyprflow-<version>.deb
   ```

4. If there are any issues with dependencies, run:
...
1. Open the terminal.
2. Navigate to your Downloads directory with:

   ```bash
   cd ~/Downloads
   ```

3. Install hyprflow using the command:
...
1. Open the hyprflow application from your applications menu.
2. Select an audio file or use the microphone to start recording.
3. Click on the "Transcribe" button.
4. Wait for hyprflow to process the audio and display the text.
